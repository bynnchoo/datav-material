...
const productPath = `/@zhunb/datav-material@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('@zhunb/datav-material', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    '@zhunb/datav-material': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
